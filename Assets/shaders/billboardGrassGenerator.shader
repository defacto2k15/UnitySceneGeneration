Shader "Custom/BillboardGeneratorTransparent"
{
	...
	SubShader
    {
		...
		//half getBladePosition(half xOffset, half2 size, half x){
		//	half baseWidth = 0.01;
		//	half widthOfBlade = (0.8-pow(IN.pos.y,3)) * baseWidth;			
		//}
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)  
        {
			...
			half xScale = _DbgVal2;
			half yScale = _DbgVal;
			half widthAtBase = _BaseWidth; 

			const int grassElementsCount = 20;
