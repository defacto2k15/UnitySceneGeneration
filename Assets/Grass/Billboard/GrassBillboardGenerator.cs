...
namespace Assets.Grass.Billboard
{
    class GrassBillboardGenerator
    {
        ...
        public GrassEntitiesSet GenerateTriangleTurf()
        {
            ...
            var obj21 = GenerateOnePlantSegment(120, 0.125f, -(3.25f) * 0.125f, (-2.5f - 0.5f) * 0.125f, 1f - 0.125f, 1, randSeed2);
            var obj22 = GenerateOnePlantSegment(120, 0.125f, (0.25f) * 0.125f, (2.5f + 0.5f) * 0.125f, 0f, 0.125f, randSeed2);

            var randSeed3 = UnityEngine.Random.value;
            var obj3 = GenerateOnePlantSegment(60, scale, 1.5f * 0.125f, 0, 0.125f, 1f - 0.125f, randSeed3);
            var obj31 = GenerateOnePlantSegment(60, 0.125f, (3.25f) * 0.125f, (-2.5f - 0.5f) * 0.125f, 1f - 0.125f, 1, randSeed3);
            var obj32 = GenerateOnePlantSegment(60, 0.125f, -(0.25f) * 0.125f, (2.5f + 0.5f) * 0.125f, 0f, 0.125f, randSeed3);
